...
class Product(models.Model):
    ...
    name = models.CharField(max_length=240, null=True, blank=False)
    image = models.ImageField(null=True, blank=True)
    brand = models.CharField(max_length=240, null=True, blank=True)
...
class Order(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    paymentMethod = models.CharField(max_length=240, null=True, blank=True)
...
class ShippingAddress(models.Model):
    ...
    postalCode = models.CharField(max_length=240, null=True, blank=True)
